          ...
          <ul className="mt-5 space-y-1.5">
            <li>
              <a
                ...
                className="focus-gold inline-flex min-h-11 items-center gap-2 text-sm text-on-dark-soft transition-colors hover:text-on-dark"
              >
      ...
      <div className="border-t border-line-dark">
        <div className="shell flex flex-col items-start justify-between gap-4 py-6 sm:flex-row sm:items-center">
          ...
          <button
            ...
            className="focus-gold inline-flex min-h-11 items-center gap-2 rounded-full font-mono text-xs tracking-[0.18em] text-gold uppercase"
          >
